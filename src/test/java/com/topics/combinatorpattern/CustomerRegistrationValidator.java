...
import static com.topics.combinatorpattern.CustomerRegistrationValidator.ValidationResult;
import static com.topics.combinatorpattern.CustomerRegistrationValidator.ValidationResult.*;
...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult> {
  ...
  static CustomerRegistrationValidator isPhoneNumberValid() {
    return customer ->
        customer.getPhoneNumber().startsWith("+7") ? SUCCESS : PHONE_NUMBER_NOT_VALID;
  }
